...
urlpatterns = [
    ...
    path('website-blog/', TemplateView.as_view(template_name='website-blog.html'), name="Blog Listing"),
    path('website-blog-post/', TemplateView.as_view(template_name='website-blog-post.html'), name="Blog Post"),
    path('website-contact/', TemplateView.as_view(template_name='website-contact.html'), name="Contact"),
